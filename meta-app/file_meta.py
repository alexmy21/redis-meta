...
def run(dir: dict|None):
    ...
    d_ret = dir_meta('file_meta', 'file_meta', '', directory)
...
'''
    ...
    redis-meta should provide source processors for most of data sources like files, data bases (relational and non relational), 
